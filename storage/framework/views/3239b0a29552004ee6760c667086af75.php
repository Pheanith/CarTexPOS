...
unset($__errorArgs, $__bag); ?>" id="price"
                    placeholder="<?php echo e(__('product.Price')); ?>" value="<?php echo e(old('price', $product->price)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                    id="quantity" placeholder="<?php echo e(__('product.Quantity')); ?>" value="<?php echo e(old('quantity', $product->quantity)); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\I4\InternetProgramming\S2Project\laravel-pos\resources\views/products/edit.blade.php ENDPATH**/ ?>